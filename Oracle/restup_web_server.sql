CREATE OR REPLACE PACKAGE  "RESTUP_WEB_SERVER" as
-- RESTup RESTful сервер консольных приложений API
...
end "RESTUP_WEB_SERVER";
/
CREATE OR REPLACE PACKAGE BODY  "RESTUP_WEB_SERVER" is
